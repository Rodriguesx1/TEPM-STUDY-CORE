...
const variants = {
  primary: "bg-primary text-primary-foreground shadow-lg shadow-primary/20 hover:bg-[#256553]",
  secondary: "bg-secondary text-secondary-foreground hover:bg-[#c7dfd3]",
