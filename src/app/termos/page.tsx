    ...
    <main className="min-h-screen px-5 py-10 md:px-10">
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div>
          ...
          <h1 className="mt-2 font-serif text-4xl font-bold text-[#2b1428]">TEPM Study</h1>
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm leading-7 text-muted-foreground">
            ...
            <p>Uploads, chats, notas, salas e memorias sao isolados por usuario e por politicas de acesso no banco.</p>
          </CardContent>
        </Card>
      </div>
    </main>
